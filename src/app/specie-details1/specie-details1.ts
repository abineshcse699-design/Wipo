...
import { SPECIE_MOCK_DATA ,  COUNTRY_CARDS_MOCK3, SPECIE_MOCK_DATA1,} from '../specie-details1/specie-mock';


@Component({
  selector: 'app-specie-details1',
  imports: [
    MatTabsModule,
    MatFormFieldModule,
    MatInputModule,
  ...
  templateUrl: './specie-details1.html',
  styleUrl: './specie-details1.scss',
})
export class SpecieDetails1 {
